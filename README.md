...
### Change dot size
As the size of dots (measured in area, amount of pixels) might differ between cameras, they can be changed. For this open the file `sizes.json`and change the variables `s1, s2, s3` to your liking.
